...
// 프로토타입("MY 내 여행 일정" / "PC 내 여행일정") 목업과 동일한 제목·날짜.
export const trips = [
  { id: "trip1", title: "여행 1", range: "2026.04.12 - 04.14", status: "예정", cover: "/images/sensoji.jpg" },
  { id: "trip2", title: "여행 2", range: "2026.05.10 - 05.12", status: "예정", cover: "/images/ueno.jpg" },
  { id: "trip3", title: "여행 3", range: "2026.06.01 - 06.03", status: "완료", cover: "/images/skytree.jpg" },
];
